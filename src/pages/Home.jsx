    ...
    <div className="container">
      ...
      >
        ...
        <div className="about3">
          ...
          <p>
            ...
            frameworks and libraries to help solve any kind of problems. And it
            is not about what technology you use, it is about how well you use
            it to solve your problem in the most effective and efficient way.
          </p>
          <div className="icons">
      ...
      >
        ...
        <p>
          ...
          it's been a journey filled with joy and cherished moments. Life has
          been a rollercoaster, and I've been lucky enough to enjoy the ride
      ...
      >
        ...
        <div>
          <h1 className="headding">
            <span className="bold">Hands On Experience</span> directly
            translates to varified certificates.
          </h1>
          <p>
